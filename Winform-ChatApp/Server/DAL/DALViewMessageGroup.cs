...
{
    public class DALViewMessageGroup
    {
        public void addViewMessage(int iduser, int idmess)
        {
            ...
            try
            {
                string query = "Insert INTO view_message_group (id_user,id_mess) " +
        ...
        public bool checkViewMessage(int iduser, int idmess)
        {
            ...
            try
            {
                string query = "SELECT * FROM `view_message_group` WHERE id_user='" + iduser + "' and id_mess='" + idmess + "'";
        ...
        public List<int> checkTheMessageForUsers(int idmess)
        {
            ...
            try
            {
                string query = "SELECT * FROM view_message_group where id_mess='" + idmess + "'";
                MySqlCommand cmd = new MySqlCommand(query, conn);
                MySqlDataReader dataReader = cmd.ExecuteReader();
